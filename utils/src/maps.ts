...
export const valorantMaps: {
  ...
  {
    name: 'Fracture',
    meta_agents: ['Brimstone', 'Raze', 'Neon', 'Vyse', 'Killjoy', 'Cypher', 'Fade', 'Breach', 'Skye', 'Astra', 'Neon'],
  ...
  {
    name: 'Abyss',
    meta_agents: ['Astra', 'Omen', 'KAY/O', 'Sova', 'Cypher', 'Vyse', 'Chamber', 'Jett', 'Yoru', 'Neon', 'Veto'],
    current_map_pool: true,
  ...
  {
    name: 'Corrode',
    meta_agents: ['Yoru', 'Waylay', 'Neon', 'Omen', 'Fade', 'Sova', 'Viper', 'Vyse', 'Chamber', 'Sage', 'Veto'],
    current_map_pool: true,
